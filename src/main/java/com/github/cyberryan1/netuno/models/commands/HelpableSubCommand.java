...
public abstract class HelpableSubCommand extends CyberSubCommand implements GenericHelpableCommand {
    ...
    public HelpableSubCommand( int helpOrder, String name, String permission, String permissionMsg, String usage, String cmdExplanation ) {
        super( name, permission, permissionMsg, usage );
        this.helpOrder = helpOrder;
        this.cmdExplanation = cmdExplanation;
    }

    public HelpableSubCommand( int helpOrder, String name, String permission, String usage, String cmdExplanation ) {
        super( name, permission, usage );
        this.helpOrder = helpOrder;
        this.cmdExplanation = cmdExplanation;
    }

    public HelpableSubCommand( int helpOrder, String name, String usage, String cmdExplanation ) {
        super( name, usage );
        this.helpOrder = helpOrder;
        this.cmdExplanation = cmdExplanation;
    }
