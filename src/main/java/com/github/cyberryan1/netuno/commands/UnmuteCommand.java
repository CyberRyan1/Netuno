...
public class UnmuteCommand extends HelpableCommand {
    ...
    public boolean execute( SentCommand command ) {
        ...
        if ( punishments.size() >= 1 ) {
            ...
            prePun.getPunishment().setPunishmentType( PunishmentType.UNMUTE );
            ...
            CommandErrors.sendNoPunishments( command.getSender(), target.getPlayer().getName(), "mute" );
        }
